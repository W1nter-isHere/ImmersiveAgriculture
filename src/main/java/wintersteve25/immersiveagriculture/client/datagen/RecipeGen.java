...
public class RecipeGen extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shapedRecipe(IAItems.WATERING_CAN_ITEM_ADVANCED, 1).key('I', Tags.Items.GEMS_DIAMOND).key('F', IAItems.FERTILIZER).key('C', Tags.Items.DYES_GREEN).patternLine("  I").patternLine("IFI").patternLine("CIC").addCriterion("has_fertilizer", hasItem(IAItems.FERTILIZER)).build(consumer);

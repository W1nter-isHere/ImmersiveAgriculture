...
public class LangGen {
    public static class English extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            add("immersiveagriculture.tooltips.sprinkler", TextFormatting.GRAY + "The Sprinkler works in a %sx%1$s" + TextFormatting.GRAY + " range, moistures farmlands in range when provided water and power. Shift right-click the block to check contained fluids. Can be disabled by giving a redstone signal");
        }

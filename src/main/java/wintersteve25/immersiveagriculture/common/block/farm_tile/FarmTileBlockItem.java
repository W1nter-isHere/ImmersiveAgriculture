...
public class FarmTileBlockItem extends FCLibBlockItem implements IHasToolTip, IColoredName {
    public FarmTileBlockItem() {
        super(IABlocks.FARM_TILE, new Item.Properties().group(ImmersiveAgriculture.creativeTab));
    }

    @Override
    public List<ITextComponent> tooltip() {
        List<ITextComponent> list = new ArrayList<>();
        list.add(new TranslationTextComponent("immersiveagriculture.tooltips.farm_tile"));
        return list;
    }

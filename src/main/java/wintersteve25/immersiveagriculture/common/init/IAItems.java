...
public class IAItems {
    public static final ScytheItem WOODEN_SCYTHE = new ScytheItem(ItemTier.WOOD, -3.2F, 6);
    public static final ScytheItem STONE_SCYTHE = new ScytheItem(ItemTier.STONE, -3.2F, 6);
    public static final ScytheItem IRON_SCYTHE = new ScytheItem(ItemTier.IRON, -3.2F, 6);
